...
plot(airquality$Temp, airquality$Ozone,
  ...
  col = "#FFA50080", # halbtransparente orange Farbe
  xlim = c(50, 100), # x-Achse begrenzen
  xlab = "Temperatur [°Fahrenheit]",
  ylab = "Ø Ozon  [ppb]",
  main = "Mehr Ozon an warmen Tagen",
  las = 1, # Achsenbeschriftung
  cex = airquality$Wind / 5) # Punktgröße skaliert durch Wind/5
# t1_ende
